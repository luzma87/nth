...
<html>
    ...
    <body>
        ...
        <div id="cuerpo" style="font-size: 11px !important;">
            ...
            %{--<input type="hidden" value="${idioma?.imagen?.id}" name="imagen">--}%
                ...
                <div class="dialog">
                    <div style="width:450px;/*height:400px;*/margin-top:15px;">
                        ...
                        <div class="fila" style="margin-bottom:10px;">
                            ...
                            <div class="valor" style="text-align:left;float:left">
                                <g:textField name="abreviacion" class="required" value="${idioma?.abreviacion}" id="abr"/>
                            </div>
                        </div>
                        ...
                        <div class="fila" style="margin-bottom:10px;">
                            ...
                            <div class="valor" style="text-align:left;float:left">
                                <input type="file" id="imagen" class="required" name="imagen"/>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript">
            ...
            $("#cuerpo").dialog({
                ...
                buttons: {
                    ...
                    <g:if test="${add == 'false'}">, "Eliminar": function () {
                        var id = "${idioma?.id}";
                        if (confirm("Está seguro de querer eliminar este idioma?")) {
                            $.ajax({
                                type: "POST",
                                url: "${createLink(controller: 'idioma', action: 'delete')}",
                                data: {
                                    id: id
                                },
                                success: function (msg) {
                                    location.href = "${createLink(controller: 'editor', action: 'empty')}";
                                    $("#btn_idioma_" + id, parent.document).remove();
                                }
                            });
                        }
                    }
