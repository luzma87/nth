    ...
    def submenu = {
        ...
        switch (tipo) {
            ...
            case "config":
                ...
                m.nombre = "Cuenta"
                m.id = 'btn_cuenta'
                m.link = createLink(controller: 'login', action: 'edit')
                m.target = "contenido"
                m.clase = ""
                lista.add(m)
                ...
                m.nombre = "Usuarios"
                m.id = 'btn_usu'
                m.link = createLink(controller: 'usuario', action: 'list')
                m.target = "contenido"
                m.clase = ""
                lista.add(m)
                ...
                m.nombre = "Sitios"
                m.id = 'btn_sitio'
                m.link = createLink(controller: 'sitio', action: 'list')
                m.target = "contenido"
                m.clase = ""
                lista.add(m)
