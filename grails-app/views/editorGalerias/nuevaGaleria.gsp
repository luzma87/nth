...
<g:form name="frmGaleria" action="guardarGaleria">
    <div style="float:left;position:relative;width:480px;height:90%;margin-top:60px;overflow:auto">
        ...
        <div class="fila" style="height: ${(tipo == 'Texto') ? '160' : '320'}px;">
            <div class="celda etiqueta">
                Dise&ntilde;o:
            </div>

            <div class="celda">
                <div class="thPreview ui-corner-all selected" title="Gallery View">
                    <img class="thumb" action="galleryView"
                         src="${resource(dir: 'images/gals', file: 'galleryView.png')}"/>
                </div>

                <div class="thPreview ui-corner-all"
                     style="padding-top:30px; height:120px; ${(tipo == 'Texto') ? 'display:none;' : ''}"
                ...
                <div class="thPreview ui-corner-all"
                     style="padding-top:20px; height:130px; ${(tipo == 'Texto') ? 'display:none;' : ''}" title="jCycle">
                    <img class="thumb" action="jCycle" src="${resource(dir: 'images/gals', file: 'jCycle.png')}"/>
                </div>

                <div class="thPreview ui-corner-all"
                     style="padding-top:10px; height:140px; ${(tipo == 'Texto') ? 'display:none;' : ''}"
    ...
    <input type="text" name="layout" id="layout" class="ui-helper-hidden" value="galleryView"/>
