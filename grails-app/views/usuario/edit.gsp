        ...
        <div class="body">
            ...
            <g:form method="post">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: usuarioInstance, field: 'pass', 'errors')}">
                                    <g:passwordField name="pass" cols="40" rows="5"/>
                                </td>
                            </tr>
                ...
                <div class="buttons">
                    ...
                    <span class="button"><g:actionSubmit class="delete" action="delete" value="Eliminar" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Está seguro de querer eliminar este usuario?')}');"/></span>
                </div>
            </g:form>
        </div>
    </body>
