    ...
    <body>
        ...
        <div id="divBody" style="position:relative;width:100%;height:90%;margin-top:40px;overflow:auto;${layout?.css}">
            ...
            <div class="drag " id="contenido"
                 style="position:absolute;z-index:3;top:${(layout?.contenido?.top > -1) ? layout?.contenido?.top : "120px"};left:${(layout?.contenido?.izq > -1) ? layout?.contenido?.izq : "200px"};width:${(layout?.contenido?.width) ? layout?.contenido?.width : "400px"};height:${(layout?.contenido?.height) ? layout?.contenido?.height : "400px"}; ${(layout?.contenido?.css) ? ((layout?.contenido?.css =~ "border") ? layout?.contenido?.css : layout?.contenido?.css + ";border:1px #cccccc solid;") : "border:1px #cccccc solid;cursor:move;background:rgba(204,204,204,0.3);"};">
        ...
        <div id="ventanaPagina" style="display:none">
            <g:form class="formLayout" action="guardarPagina" controller="editor" enctype="multipart/form-data">
                ...
                <input type="hidden" name="idioma.izq" id="izq" value="${(layout?.idioma?.izq) ? layout?.idioma?.izq : "200"}">
