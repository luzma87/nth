        ...
        <div class="principal ui-corner-all">
            ...
            <div class="form ui-corner-all ">
                ...
                <div style="width: 95%;margin: auto;margin-top: 20px;font-size: 11px !important;">
                    <g:form action="saveSitio" name="frmSitio">
                            ...
                            <tbody>
                                ...
                                <tr class="prop">
                                    ...
                                    <td valign="top"
                                        ...
                                        <g:textField class="required" name="nombre" maxlength="20" minlength="3" value="${sitioInstance?.nombre}"/>
                                    </td>
                                </tr>
                                ...
                                <tr class="prop">
                                    ...
                                    <td valign="top"
                                        ...
                                        <g:textField name="organizacion" maxlength="60" minlength="3"
                                                     value="${sitioInstance?.organizacion}" class="required"/>
                                    </td>
                                </tr>
                                ...
                                <tr class="prop">
                                    ...
                                    <td valign="top"
                                        ...
                                        <g:textField name="contacto" maxlength="100" value="${sitioInstance?.contacto}" class="required"/>
                                    </td>
                                </tr>
                                ...
                                <tr class="prop">
                                    ...
                                    <td valign="top"
                                        ...
                                        <g:textField name="telefono" maxlength="10" class="required" value="${sitioInstance?.telefono}"/>
                                    </td>
                                </tr>
